...
function Draggable(){
	...
	this.setselected=function(val){
		//pendiente: evaluar la posibilidad de corroborar que los elementos están
		//seleccionados en función de si estan en pointer.selected & pointer.dragging
		this.selectflag &= ~(1<<2);//clear
		this.selectflag |= (val<<2);
		if(val){
			pointer.selected=this;
		}else{
